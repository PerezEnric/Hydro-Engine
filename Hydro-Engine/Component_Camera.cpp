...
Component_Camera::Component_Camera(GameObject* gameObject, COMPONENT_TYPE type)
{
	...
	frustum.verticalFov = 90 * RADTODEG; //We have to depen on a certain FOV. Normally is the vertical FoV. We assign 90 degrees because is normally used in PC games (Wikipedia rules)
